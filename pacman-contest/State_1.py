class State_1:
    ...
    def getCurrentState(self, initState):
        ...
        distanceFromSecondEnemyToOurCapsule = min(map(lambda x: self.Agent.getMazeDistance(secondEnemyCurPosition, x), ourCapsules)) if secondEnemyCurPosition and ourCapsules else 99999
